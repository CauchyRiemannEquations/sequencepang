...
- 기본 랭킹은 이번 주 랭킹 TOP 30입니다.
- 시즌 랭킹은 별도 탭에서 확인할 수 있습니다.
- 주간 랭킹은 매주 월요일 00:00 KST 기준으로 자동 전환됩니다.
- 점수 데이터는 삭제하지 않습니다.
- 새 점수 문서에는 `rankingWeek`, `rankingWeekStart` 필드가 함께 저장됩니다.
- 주간 랭킹은 기능 배포 이후 저장된 점수부터 가장 정확하게 반영됩니다.
- 동일 닉네임은 주간/시즌 랭킹에 한 번만 표시됩니다.
